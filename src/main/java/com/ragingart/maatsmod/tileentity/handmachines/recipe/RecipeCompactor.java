 ...
 */
public class RecipeCompactor {

    int inputamount, outputamount, duration;
    Item input, output;
    RecipeCompactor next;


    public RecipeCompactor(int s_duration, int s_inputamount, int s_outputamount, Item s_input, Item s_output){
    ...
    public void addRecipe(int s_duration, int s_inputamount, int s_outputamount, Item s_input, Item s_output){
        if(next != null) {
            ...
            next = new RecipeCompactor(s_duration, s_inputamount, s_outputamount, s_input, s_output);
        }
    }
    ...
    public RecipeCompactor getRecipe(Item item){
        if (input == item)
            return this;
        else if(next != null)
