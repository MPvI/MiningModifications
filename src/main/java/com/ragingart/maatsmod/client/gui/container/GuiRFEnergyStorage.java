...
import com.ragingart.maatsmod.tileentity.TileEntityRFEnergyStorage;
...
public class GuiRFEnergyStorage extends GuiContainer {
    ...
    {
        String containerName = StatCollector.translateToLocal(tileEntityRFEnergyStorage.getInventoryName());
