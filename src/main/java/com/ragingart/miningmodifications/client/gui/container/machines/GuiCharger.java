...
public class GuiCharger extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int x, int y)
    {
        ...
        fontRendererObj.drawString(String.valueOf(tileEntityCharger.getEnergyStored(EnumFacing.UP)), xSize / 2 - fontRendererObj.getStringWidth(String.valueOf(tileEntityCharger.getEnergyStored(EnumFacing.UP))) / 2, 45, 4210752);
    }
